	...
	<div class="panel-wrapper collapse in">
		<div class="panel-body">
			<div class="row">
				...
				<a href="?p=Details&id=<?php echo $_GET["id"] ?>&a=Projects"><button class="btn btn-default btn-anim"><i class="fa fa-pencil"></i><span class="btn-text">Project</span></button></a>
